...
namespace SieveOfEratosthenes.Core
{
    ...
    {
        public static readonly Color DefaultColor = Colors.DarkGray;
        public static readonly Color PrimeColor = Colors.Chartreuse;
        public static readonly Color MultipleOfTwoColor = Colors.CornflowerBlue;
